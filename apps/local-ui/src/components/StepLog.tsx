...
export const ACTION_LABELS: Record<string, { labelKey: string; toolKey: string }> = {
  ...
  'brain.plan':     { labelKey: 'step.action.brain.plan',     toolKey: 'step.tool.AIProvider' },
  'brain.replan':   { labelKey: 'step.action.brain.replan',   toolKey: 'step.tool.AIProvider' },
  'policy.guard':   { labelKey: 'step.action.policy.guard',   toolKey: 'step.tool.ExplorationAgent' },
  ...
  'login.captcha':  { labelKey: 'step.action.login.captcha',  toolKey: 'step.tool.playwright' },
  'login.verify':   { labelKey: 'step.action.login.verify',   toolKey: 'step.tool.playwright' },
  'login.manual':   { labelKey: 'step.action.login.manual',   toolKey: 'step.tool.playwright' },
...
function promptSummaryLabel(key: string): string {
  const labels: Record<string, string> = {
    ...
    brainPhase: 'step.modal.promptSummary.brainPhase',
    brainCandidates: 'step.modal.promptSummary.brainCandidates',
    brainAvoid: 'step.modal.promptSummary.brainAvoid',
